...
!!! tips
    ...
    + 他にも、[Ollama Cloud](https://ollama.com/cloud)や、[NanoGPT](https://nano-gpt.com/)といった定額制のAPIサービスもあります。(noteなどで紹介されていますので調べてみてください)
...
!!! warning "重要"
    ...
    **例外的に、[Ollama Cloud](https://ollama.com/cloud)は、無料プランでも入出力が記録されない方針を採用していますので、そちらも検討してください。**
